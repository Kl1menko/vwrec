...
export function initReviewsSlider() {
  qsa('[data-reviews-slider]').forEach((slider) => {
    const track = slider.querySelector('[data-reviews-slider-track]')
    const prevButton = slider.querySelector('[data-reviews-slider-prev]')
    const nextButton = slider.querySelector('[data-reviews-slider-next]')
