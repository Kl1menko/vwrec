  ...
  return {
    ...
    home: {
      ...
      casesSection: {
        ...
        title: 'Recruitment projects for employers',
        lead:
          'Examples of how staffing shortages were turned into a structured hiring route with timeline, sourcing model, and launch support.',
        cta: 'Project examples',
      },
      faq: {
    ...
    thankYouReport: {
      title: 'Thank you. Your report request was received.',
      lead: 'We captured your request and the team will follow up with the report and next practical step shortly.',
      ctaLabel: 'Back to homepage',
      secondaryCtaLabel: 'Open contacts page',
    },
    contacts: {
    ...
    ui: {
      ...
      fieldEmail: 'Email',
      fieldPhone: 'Phone',
      fieldIsBusiness: 'Are you a real agency or business?',
      fieldTargetCountries: 'Which countries are you interested in?',
      fieldWorkersCount: 'How many workers do you need?',
      fieldSelectOption: 'Select an option',
      optionYes: 'Yes',
      optionNo: 'No',
      ...
      guaranteesReplacementLabel: 'Launch guarantee',
      guaranteesReplacementUnit: 'fee',
      guaranteesReplacementWarrantyDays: 30,
      guaranteesReplacementWarrantyLabel: 'days warranty',
      guaranteesReplacementReplyHours: 48,
      guaranteesReplacementReplyLabel: 'hours reply',
      guaranteesSupportBadge: 'One team across the whole process',
      guaranteesCandidatesDays: 10,
      guaranteesCandidatesDaysLabel: 'days to candidates',
      guaranteesSupportPercentLabel: '% support',
      guaranteesOneTeamCount: 1,
      guaranteesOneTeamLabel: 'team',
      guaranteeTimelineStepOne: 'Selection',
      guaranteeTimelineStepTwo: 'Documents',
      guaranteeTimelineStepThree: 'Logistics',
      guaranteeTimelineStepFour: 'Arrival',
      guaranteeTimelineStepFive: 'Shift',
      ...
      genericPageCardTwo: 'Metadata and structure are ready for further expansion',
      genericPageCardThree: 'Each route is generated separately for every locale',
    },
    quiz: {
